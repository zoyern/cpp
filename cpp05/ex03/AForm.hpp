...
#ifndef EXEPTIONS
	#define EXEPTION_TOOHIGHT "Grade is too high !!"
	#define EXEPTION_TOOLOW "Grade is too low !!"
	#define EXEPTION_NOTSIGN "Form is not signed !!"
	#define EXEPTION_NOTEXEC "An error occurred during execution..."
#endif
...
public:
	...
	bool				checkGrade(size_t grade, size_t grade_min) const;
